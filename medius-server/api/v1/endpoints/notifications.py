...
# from schemas.notification import NotificationCreate, NotificationDelete, NotificationUpdate
...
# @router.get("/view-by-user-id/{post_id}", response_model=List[schemas.Comment])
