...
def create_topic(db: Session = Depends(deps.get_db), *, creating_topic: TopicCreate, current_user: models.User = Depends(deps.get_current_admin)) -> Any:
    """
    Create new topic
    """
...
def update_topic(db: Session = Depends(deps.get_db), *, updating_topic: TopicUpdate, current_user: models.User = Depends(deps.get_current_admin)) -> Any:
    """
    Update topic
    """
...
def delete_topic(db: Session = Depends(deps.get_db), deleting_topic: TopicDelete = None, current_user: models.User = Depends(deps.get_current_admin)) -> Any:
    """
    Delete topic
    """
